...
transcript file ../transcripts/transcript_$5
...
# Load project
  eval vsim -GWRITE_NR=$1 -GREAD_NR=$2 -GWRITE_ORDER=$3 -GREAD_ORDER=$4 -GTEST_CASE=$5 -GSEED_VAL=$6 -sva top -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE 
